 ...
 * 
 * @author Nithish
 * this class consists of add patient script  and deleting user script
 *
 */

@Listeners(com.comcast.crm.generic.listenerutility.ListImpClass.class)
public class Admin1_patient_user_Test extends AdminBaseClass {

	/**
	 * this method consists of add patient script
	 * @throws Throwable
	 */
	...
	/**
	 * this method consists of delete user script
	 * @throws Throwable
	 */
	@Test
